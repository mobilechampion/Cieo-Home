...
public class AGContainerXmlAttributes extends AGXmlCommonAttributes{
	public final static String SCROLLVERTICAL = "scrollvertical";
	public final static String SCROLLHORIZONTAL = "scrollhorizontal";
	public final static String INNER_ALIGN = "inneralign";
	public final static String INNER_V_ALIGN = "innervalign";
