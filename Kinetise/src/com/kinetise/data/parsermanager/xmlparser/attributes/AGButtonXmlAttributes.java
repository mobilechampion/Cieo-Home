...
public class AGButtonXmlAttributes extends AGImageXmlAttributes {
    ...
    public final static String ACTIVE_SRC = "activesrc";
    public final static String ACTIVE_COLOR = "activecolor";
    public final static String ACTIVE_BORDER_COLOR = "activebordercolor";
