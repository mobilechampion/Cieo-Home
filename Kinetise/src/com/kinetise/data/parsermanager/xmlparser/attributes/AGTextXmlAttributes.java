...
public class AGTextXmlAttributes extends AGXmlCommonAttributes {
	...
	public final static String TEXT_ALIGN = "textalign";
	public final static String TEXT_DECORATION = "textdecoration";
	public final static String FONT_WEIGHT = "fontweight";
